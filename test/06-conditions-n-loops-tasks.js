...
function isInsideCircle(circle, point) {
    if (Math.sqrt((circle.center.x - point.x) * (circle.center.x - point.x) + (circle.center.y-point.y) * (circle.center.y - point.y)) <circle.radius)
        return true;
    else 
        return false;   
    throw new Error('Not implemented');
